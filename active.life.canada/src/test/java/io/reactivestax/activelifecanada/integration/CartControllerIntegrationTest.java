package io.reactivestax.activelifecanada.integration;
...
class CartControllerIntegrationTest {
    ...
    void testGetCart() {
        Response response = given()
                ...
                .contentType(ContentType.JSON)
                .when()
                .get(BASE_URL + "/87dbcf21-45e6-47dc-8a72-991ba9a2070d")
                .then()
                .log().all()
                .statusCode(200)
                .extract()
    ...
    void testDeleteCart() {
        Response response = given()
                ...
                .contentType(ContentType.JSON)
                .when()
                .delete(BASE_URL + "/deleteCart/5addbaeb-cbdf-488e-acd8-cbc26dc80f0b")
                .then()
                .log().all()
                .statusCode(200)
                .extract()
